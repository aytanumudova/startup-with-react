...
import reportImg from "../assets/svgs/fast-reports-section/report.svg";
const FastReports = () => {
  ...
  return (
    <div className="row m-auto container fast-reports-section">
      <div className="col-12 col-lg-6 left-side">
        ...
        <div className="list mt-5">
          <div className="list-item d-flex d-inline align-items-baseline gap-3">
            <button className="button" ref={buttonRef} onClick={addActiveClass}>
              <svg
                width="6"
                height="10"
                viewBox="0 0 6 10"
      ...
      <div className="col-12 col-lg-6 right-side mt-4 mt-lg-0  d-flex align-items-center justify-content-center">
